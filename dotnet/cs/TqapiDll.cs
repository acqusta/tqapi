    ...
    namespace Api
    {
        namespace Impl
        {
            class TqapiDll
            {
                ...
                [DllImport("tqapi.dll", EntryPoint = "dapi_set_callback")]
                ...
                [DllImport("tqapi.dll", EntryPoint = "tapi_set_callback")]

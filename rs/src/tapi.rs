...
// use tqapi::tquant::api;

// //pub mod tquant { pub mod ffi {
...
//         pub fn tqapi_free_get_ticks_result(dapi : *mut CDataApi, result : *mut GetTicksResult);
//     }
